odoo.define('dynamic_dashboard_zg.Dashboard', function (require) {
    "use strict";
        ...
        render_dashboards: function () {
            ...
            _.each(this.block_ids, function (block) {//Loop all chart and tile
                if (block['type'] == 'tile') {
                    ...
                    console.log(eval(chart_type)[0])
                    console.log(eval(chart_type)[1])
    ...
    core.action_registry.add('dynamic_dashboard_zg', DynamicDashboard);
